...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: Member Type
        Gate::define('mtype_access', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('mtype_create', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('mtype_edit', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('mtype_view', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
        Gate::define('mtype_delete', function ($user) {
            return in_array($user->role_id, [1, 2]);
        });
